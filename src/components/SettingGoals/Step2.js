      ...
      <>
        <div className="settinggoals-container">
          ...
          <div className="container">
            <label htmlFor="pages">Herinner mij om te studeren</label>
            <p>Selecteer een tijd wanneer je een melding wilt ontvangen. </p>
          ...
          <div className="container">
            <label>Hetzelfde tijdstip voor elke studiedag herinnering</label>
